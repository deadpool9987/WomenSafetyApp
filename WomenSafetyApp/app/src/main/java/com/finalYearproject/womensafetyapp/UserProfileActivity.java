...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_name.setText((shared.getString("user_name","Guest User")));
        user_mobile_number.setText((shared.getString("user_mobile_number","guestuser@gmail.com")));
        user_aadhar_number.setText((shared.getString("user_aadhar_number","Guest")));
        user_emergency_contact.setText(shared.getString("user_emergency_contact","222222"));
        user_email.setText((shared.getString("user_email","#1234")));
        user_password.setText((shared.getString("user_full_name","Guest User")));
        userID = (shared.getString("user_id","Guest User"));
        profileURl = (shared.getString("user_profile_pic",""));
        if(!profileURl.equals("")){
            outside_image_view.setVisibility(View.GONE);
            Glide.with(mContext).load(profileURl).into(profile_pic);
        }
    ...
    private void validateSubmit(){
        if(profile_pic.getDrawable() == null){
            ...
            AlertDialogClassCommon.showDialogError(mContext,"Enter Valid Emergency Mobile Number");
        }
...
//    }
    ...
    private void updateUser(){
        ...
        pDialog.show();
        StringRequest strReq = new StringRequest(Request.Method.POST,
                ApiUrls.updateUser, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_mobile_number", userMobileNumber);
                params.put("user_aadhar_number", userAadharNumber);
                params.put("user_email", userEmail);
                params.put("user_password", userPassword);
                params.put("user_emergency_contact", userEmergencyContact);
                params.put("user_profile_pic", "");
    ...
    private void updateUserWithImage(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                try {
                    ...
                    if (rootjsonobj.has("error")) {
                        ...
                        if (error == false) {
                            JSONObject dataObject = rootjsonobj.getJSONObject("data");
                            SharedPreferences shared = mContext.getSharedPreferences("MyPreferences", MODE_PRIVATE);
                            SharedPreferences.Editor editor = shared.edit();
                            editor.putString("user_name",dataObject.getString("user_name"));
                            editor.putString("user_mobile_number",dataObject.getString("user_mobile_number"));
            ...
            protected String doInBackground(Void... params) {
                ...
                UserProfileActivity.ImageProcessClass imageProcessClass = new UserProfileActivity.ImageProcessClass();
                ...
                HashMapParams.put("user_profile_pic", ConvertImage);
                HashMapParams.put("user_id", userID);

                String FinalData = imageProcessClass.ImageHttpRequest(ApiUrls.updateUser, HashMapParams);
